					...
					if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
						...
						foreach ($_POST AS $k=>$v) {
							...
							if (substr($k,0,5) == "form_") {
								...
								$insert = $db->prepare("INSERT INTO ".TABLE." SET proje_baslik = ?, proje_seo = ?, proje_aciklama = ?, proje_yil = ?,  proje_adres = ?, proje_metrekare = ?, proje_daire = ?, proje_blok = ?, proje_tamamlanma = ?,  proje_harita = ?, proje_video = ?, proje_resim = ?, dil_id = ?, kategori_id = ?, proje_durum = ?, proje_ust_id = ?");
								$insert->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key], $proje_yil[$key], $proje_adres[$key], $proje_metrekare[$key], $proje_daire[$key], $proje_blok[$key],  $proje_tamamlanma[$key],   $proje_harita[$key],  $proje_video[$key],  $proje_resim, $key, $kategori_id, $proje_durum, $LastID));
...
?>
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Yıl</label>
																<input type="text" name="proje_yil[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Yıl" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adres</label>
																<input type="text" name="proje_adres[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Adres" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Metre Kare</label>
																<input type="text" name="proje_metrekare[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Metre Kare" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Daire Sayısı</label>
																<input type="text" name="proje_daire[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Daire Sayısı" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Blok Sayısı</label>
																<input type="text" name="proje_blok[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Blok Sayısı" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Tamamlanma Tarihi</label>
																<input type="text" name="proje_tamamlanma[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Tamamlanma Tarihi" >
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Videosu</label>
																<input type="text" name="proje_video[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Videosu"  >
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Harita Kodu</label>
																<input type="text" name="proje_harita[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Harita Kodu"  >
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
					...
					if(isset($submitControl)){
						if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
							...
							foreach ($_POST AS $k=>$v) {
								...
								if (substr($k,0,5) == "form_") {
									$key = str_replace("form_","",$k);
									$update = $db->prepare("UPDATE ".TABLE." SET  	 proje_baslik = ?, proje_seo = ?, proje_aciklama = ?, proje_yil = ?,  proje_adres = ?, proje_metrekare = ?, proje_daire = ?, proje_blok = ?, proje_tamamlanma = ?, proje_harita = ?, proje_video = ?, proje_resim = ?, proje_durum = ?, kategori_id = ? WHERE proje_ust_id = ? AND dil_id = ?");
									$update->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key], $proje_yil[$key], $proje_adres[$key], $proje_metrekare[$key], $proje_daire[$key], $proje_blok[$key],  $proje_tamamlanma[$key],   $proje_harita[$key],  $proje_video[$key], $proje_resim, $proje_durum, $kategori_id, $id, $key));
								}
							}
							if ($update) {
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Yıl</label>
																<input type="text" name="proje_yil[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Yıl" required="" value="<?php echo GetTableValue("proje_yil",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Adres</label>
																<input type="text" name="proje_adres[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Adres" required="" value="<?php echo GetTableValue("proje_adres",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Metre Kare</label>
																<input type="text" name="proje_metrekare[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Metre Kare" required="" value="<?php echo GetTableValue("proje_metrekare",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>	<div class="col-lg-12 mb-2">
																<div class="form-group">
																	<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Daire Sayısı</label>
																	<input type="text" name="proje_daire[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Daire Sayısı" required="" value="<?php echo GetTableValue("proje_daire",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
																</div>
															</div>	<div class="col-lg-12 mb-2">
																	<div class="form-group">
																		<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Blok Sayısı</label>
																		<input type="text" name="proje_blok[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Blok Sayısı" required="" value="<?php echo GetTableValue("proje_blok",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
																	</div>
																</div>
																<div class="col-lg-12 mb-2">
																	<div class="form-group">
																		<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Tamamlanma Tarihi</label>
																		<input type="text" name="proje_tamamlanma[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Tamamlanma Tarihi" required="" value="<?php echo GetTableValue("proje_tamamlanma",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
																	</div>
																</div>
																<div class="col-lg-12 mb-2">
																	<div class="form-group">
																		<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Proje Videosu</label>
																		<input type="text" name="proje_video[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Proje Videosu" required="" value="<?php echo GetTableValue("proje_video",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
																	</div>
																</div>
																<div class="col-lg-12 mb-2">
																	<div class="form-group">
																		<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Harita Kodu</label>
																		<input type="text" name="proje_harita[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Harita Kodu" required="" value="<?php echo GetTableValue("proje_harita",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
																	</div>
																</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
